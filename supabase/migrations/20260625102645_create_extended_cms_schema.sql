...
CREATE POLICY "navigation_menu_full_access" ON navigation_menu FOR ALL TO authenticated, anon USING (true) WITH CHECK (true);

CREATE POLICY "faqs_public_read" ON faqs FOR SELECT TO PUBLIC USING (is_active = true);
CREATE POLICY "faqs_full_access" ON faqs FOR ALL TO authenticated, anon USING (true) WITH CHECK (true);

CREATE POLICY "page_sections_public_read" ON page_sections FOR SELECT TO PUBLIC USING (is_active = true);
CREATE POLICY "page_sections_full_access" ON page_sections FOR ALL TO authenticated, anon USING (true) WITH CHECK (true);